...
e_last2=robustness_echo_effect.plot_fig2(10000,0.05,0.26,100,400,0.3,1,0.6)
...
# big1_a=big1*100
# semall1_a=semall1*100
# big2_a=big2*100
# semall2_a=semall2*100
...
plt.legend()  
plt.tight_layout()
plt.savefig(r'E:\AAA\论文写作\A群体免疫\A优化模型\写作内容\投稿\英文投稿\英文\CHB\退修\imag\FIG9c.tif',
			 format="tif" ,
			 dpi=1000,
			 bbox_inches="tight",
