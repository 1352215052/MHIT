...
def threshold_find(start_thred,end_thred,t_test,t_control,seed_num,num_prop,fc_prop,s_start):
	...
	# mpl.rcParams['savefig.dpi'] = 300  # 保存图形的DPI
	# mpl.rcParams['figure.dpi'] = 300  # 显示图形的DPI
	# mpl.rcParams['axes.unicode_minus'] = False  # 解决负号显示问题
	 
	# # 设置字体为Times New Roman（或者其他你需要的字体）
	# mpl.rcParams['font.family'] = 'serif'
	# # mpl.rcParams['font.sans-serif'] = ['SimHei']  # 指定默认字体
	# mpl.rcParams['font.serif'] = ['Times New Roman']
	# # mpl.rcParams['font.serif'] = ['Simsun']
	# plt.figure(figsize=(6, 4))  # 设置图形大小（宽，高），单位为英寸

	plt.plot(t,e_avg,label='Without echo chamber',color="#0072B2",  linestyle="-")
