...
def state_bar(seed_list_find):
	...
	for seed_list in seed_list_find:
		if a==1:
			...
			plt.hist(seed_list, label='Neutral',color="#009E73", alpha=0.7,bins=4)  
		else:
...
seed_list_attenuation=time_state(350,seed_list,0.3,1,0.05,0.26,0.6)
...
plt.legend()  
plt.savefig(r'E:\AAA\论文写作\A群体免疫\A优化模型\写作内容\投稿\英文投稿\英文\CHB\退修\imag\FIG11b.tif',
			 format="tif" ,
			 dpi=1000,
			 bbox_inches="tight",
